...
export function useAsciiPatternBuilders({
  imageUrl,
  deformTexture,
  deformStrength = 0.1,
  randomSpeed = 0.1,
  ...
  const shaderMaterial = useShader(
    {
      ...
      fragmentShader: /*glsl*/ `
          ...
          void main() {
            ...
            originalCol = adjustSaturation(originalCol, uSaturation);
  ...
  const render = useCallback<RenderCallback>(
    ...
    [imageTexture, uniforms, deformTexture, patternRenderTarget, postScene],
  );
