...
The [Chainstack Faucet](https://faucet.chainstack.com/base-testnet-faucet) provides free testnet ETH on Base Sepolia - one claim per 24 hours.

:::info

The Chainstack faucet allows developers to claim Base Sepolia testnet funds with a free Chainstack account through an API key — you can automate top-ups with a script.
