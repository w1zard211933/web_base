...
![Example](/images/frames/updated-100-lines.png)
...
Update it to grab query parameters from your endpoint, and show the zincscale image if either is missing:
...
![Sad Whale](/images/frames/gave-me-away.png)
...
![Real NFT](/images/frames/real-nft.png)
...
[transaction in a frame]: ./transactions.mdx
