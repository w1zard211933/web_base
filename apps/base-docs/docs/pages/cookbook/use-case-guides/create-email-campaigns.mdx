...
![image-resend-api-page](/images/resend-email-campaigns/resend-api-keys.png)
...
![image-wc-project-id](/images/resend-email-campaigns/wc-project-page.png)
...
![cdp-home-onchainkit-api](/images/resend-email-campaigns/ock-dashboard.png)
...
![image-create-template](/images/resend-email-campaigns/ock-use-template.png)
...
In this template, environment variables are stored in a `.env.example` file. You’ll need to rename this file to `.env` to ensure the environment variables are properly loaded. Run the following command:
...
![image-of-vercel-project-add](/images/resend-email-campaigns/vercel-import-project.png)
...
![image-deployed-vercel](/images/resend-email-campaigns/site-load.png)
...
export default function Page() {
  ...
  return (
    <div className="flex h-full w-96 max-w-full flex-col px-1 md:w-[1008px]">
      ...
      <section className="templateSection flex w-full flex-col items-center justify-center gap-4 rounded-xl bg-zinc-100 px-2 py-4 md:grow"></section>
      <Footer />
    </div>
  );
}
...
```typescript filename="src/components/EmailTemplate.tsx"
...
```html
<section
  className="templateSection flex w-full flex-col items-center justify-center gap-4 rounded-xl bg-zinc-100 px-2 py-4 md:grow"
>
  <div
...
>
  <div className="w-80 rounded-lg bg-white p-8 shadow-lg">
    ...
    <form onSubmit="{handleSubscribe}" className="space-y-4">
      <h2 className="mb-6 text-center text-2xl font-bold text-zinc-800">Join our mailing list</h2>
      {/* Form inputs */}
      <div className="space-y-2">
        <input
          ...
          className="focus:black w-full rounded-md border border-zinc-300 p-3 text-sm focus:outline-none focus:ring-2"
          required
        />
        <input
          type="text"
...
```typescript filename="src/app/api/send/route.ts"
...
![resend-](/images/resend-email-campaigns/resend-mailing-list-prompt.png)
...
![resend-](/images/resend-email-campaigns/resend-user-subscribed.png)
