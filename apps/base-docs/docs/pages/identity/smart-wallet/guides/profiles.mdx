---
title: 'Using Profiles with Smart Wallet'
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
  <img
    alt="Profiles Demo"
    src="/images/smart-wallet/ProfilesDemo.gif"
    width="1000"
    loading="lazy"
...
Profiles are only available on the development environment for now.

Profiles will be available in the production environment soon,
so you won't need to specify the `keysUrl` parameter.
