...
The code below is also in our [Wagmi Smart Wallet template](https://github.com/base/demos/tree/master/smart-wallet/wagmi-demo).

## Skip ahead and clone the template

If you are looking for a complete example, you can skip the steps below and clone the Wagmi Smart Wallet template:

<GithubRepoCard title="Wagmi Smart Wallet Template" githubUrl="https://github.com/base/demos/tree/master/smart-wallet/wagmi-demo" />

Follow the instructions in the README to install the dependencies and run the app to use the `Paymaster` component.
...
As you can see in the Paymaster transaction [component](https://github.com/base/demos/blob/master/smart-wallet/wagmi-demo/src/components/TransactWithPaymaster.tsx), we use a proxy to protect
...
We also created a [minimalist proxy API](https://github.com/base/demos/blob/master/smart-wallet/wagmi-demo/src/app/api/paymaster/route.ts)
which you can use as the `PaymasterServiceUrl` in the [`TransactWithPaymaster` component](https://github.com/base/demos/blob/master/smart-wallet/wagmi-demo/src/components/TransactWithPaymaster.tsx).
...
For example, in the [template](https://github.com/base/demos/tree/master/smart-wallet/wagmi-demo), we create a `willSponsor` function in [`utils.ts`](https://github.com/base/demos/blob/master/smart-wallet/wagmi-demo/src/app/api/utils.ts) to add some extra validation if you need
...
[template](https://github.com/base/demos/tree/master/smart-wallet/wagmi-demo).

In the template, we create a [`TransactWithPaymaster`](https://github.com/base/demos/blob/master/smart-wallet/wagmi-demo/src/components/TransactWithPaymaster.tsx) component that uses the `useWriteContracts` hook to send a transaction with a Paymaster.

The [`TransactWithPaymaster`](https://github.com/base/demos/blob/master/smart-wallet/wagmi-demo/src/components/TransactWithPaymaster.tsx) component is used in the [`page.tsx`](https://github.com/base/demos/blob/master/smart-wallet/wagmi-demo/src/app/page.tsx) file.
