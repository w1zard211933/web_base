...
1. Open a terminal and clone the repo: `git clone https://github.com/base/demos/`
2. Navigate to the directory: `cd demos/smart-wallet/wagmi-demo`
3. Install bun if you don't have it: `curl -fsSL https://bun.sh/install | bash`
4. Install packages: `bun i`
5. Run next app: `bun run dev`
...
If you are looking to handle onchain signatures (eg. [Permit2](https://github.com/base/demos/blob/master/smart-wallet/wagmi-demo/src/components/Permit2.tsx)), you can sign them in the same way as above.
...
:::info
There is an example implementation of Permit2 using Wagmi in the [demos repository](https://github.com/base/demos/blob/master/smart-wallet/wagmi-demo/src/components/Permit2.tsx).
:::
