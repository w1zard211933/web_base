...
We recommend Viem's [`verifyMessage`](https://viem.sh/docs/actions/public/verifyMessage#verifymessage) ([example](https://github.com/base/demos/blob/master/smart-wallet/wagmi-demo/src/components/SignMessage.tsx))
and [verifyTypedData](https://viem.sh/docs/actions/public/verifyTypedData) ([example](https://github.com/base/demos/blob/master/smart-wallet/wagmi-demo/src/components/TypedSign.tsx)).
...
util from Viem. Abbreviated example below. See full example [here](https://github.com/base/demos/blob/master/smart-wallet/wagmi-demo/src/components/Permit2.tsx).
