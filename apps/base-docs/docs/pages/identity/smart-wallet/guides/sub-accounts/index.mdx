...
3. [Using Sub Accounts with OnchainKit](/identity/smart-wallet/guides/sub-accounts/add-sub-accounts-to-onchainkit-minikit) - Learn how to use Sub Accounts with OnchainKit. This guide demonstrates:

   - Creating a new OnchainKit project
   - Configuring OnchainKit with development environment settings
   - Creating a basic wallet connection interface
   - Using Sub Accounts with OnchainKit
