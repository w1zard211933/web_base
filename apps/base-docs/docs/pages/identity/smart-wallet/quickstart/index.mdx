...
1. [Quick Demo using OnchainKit](/identity/smart-wallet/quickstart/quick-demo) - The fastest way to see Smart Wallet in action
2. [Add to Existing Next.js Project](/identity/smart-wallet/quickstart/nextjs-project) - Step-by-step integration with an existing Next.js application using Wagmi
3. [Add to Existing React Native Project](/identity/smart-wallet/quickstart/react-native-project) - A simple installation instruction. _A more detailed guide coming soon._
...
- [Support Spend Limits](/identity/smart-wallet/guides/spend-limits): Enable third-party signers to spend user assets
