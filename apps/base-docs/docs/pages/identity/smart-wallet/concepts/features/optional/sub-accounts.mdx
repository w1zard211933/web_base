...
Refer to the [Implementation Guide](/identity/smart-wallet/guides/sub-accounts) or the [Technical Reference](/identity/smart-wallet/technical-reference/sub-account-reference) for more details on how to create and manage Sub Accounts.
